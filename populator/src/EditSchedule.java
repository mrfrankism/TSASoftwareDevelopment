...
public class EditSchedule {
	 ...
	 */
	public static void newFrame(String title, String [] args) { //have the parameters be the classses and the name of the student
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EditSchedule window = new EditSchedule(title, args);
	 ...
	 */
	public EditSchedule(String title, String [] arg) {
	 ...
	 */
	private void initialize(String title, String currentClasses []) {
		frame = new JFrame();
